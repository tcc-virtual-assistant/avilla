...
export function Planta_spin(props) {
  const { nodes, materials } = useGLTF("/planta_inteira_sem_pins.glb");
  return (
...
useGLTF.preload("/planta_inteira_sem_pins.glb");
