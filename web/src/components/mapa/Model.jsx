...
export function Model(props) {
  const { nodes, materials } = useGLTF("/Bosch.gltf");
  return (
    <group {...props} dispose={null} position={[-10.5,-4,-15]}>
      <group
