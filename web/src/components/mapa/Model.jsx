...
export function Model(props) {
  const { nodes, materials } = useGLTF("/Bosch2.glb");
  return (
    <group {...props} dispose={null} position={[-11,-3,-11]}>
      ...
      <mesh
        ...
        position={[10.48, 0.02, 6.26]}
        scale={[1.18, 0.26, 1.18]}
      />
    </group>
  );
}

useGLTF.preload("/Bosch2.glb");
