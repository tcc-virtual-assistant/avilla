  ...
  return (
    <>
      ...
      >
        <SwiperSlide>
          <div class="flex flex-col lg:flex-row overflow-hidden pl-20 pr-20 mt-14 lg:mt-44">
            ...
            <div class="pl-20 pr-20 flex flex-col mb-6">
              <div class="text-roxo font-bold text-center text-4xl mb-6 leading-tight">
                Soluções Digitais
              </div>
              <p class="text-grey-darker text-2xl leading-tight">{text1}</p>
              <a
                class="text-xl bg-roxo py-3 rounded-lg text-white w-1/4 text-center text-bold block mt-6"
                onClick={handleClick}
              >
                Clique aqui
              </a>
        ...
        <SwiperSlide>
          <div class="flex flex-col lg:flex-row overflow-hidden pl-20 pr-20 lg:mt-36">
            <img
              class="block w-full lg:w-1/3 flex-none bg-cover lg:h-full rounded-xl"
              src="../images/mecatronica.png"
            />
            <div class="pl-20 pr-20 flex flex-col mb-6">
              <div class="text-roxo font-bold text-center text-4xl mb-6 leading-tight">
                Mecatrônica
              </div>
              <p class="text-grey-darker text-2xl leading-tight">{text2}</p>
              <a
                class="text-xl bg-roxo py-3 rounded-lg text-white w-1/4 text-center text-bold block mt-6"
                onClick={handleClick}
              >
        ...
        <SwiperSlide>
          <div class="flex flex-col lg:flex-row overflow-hidden pl-20 pr-20 mt-14 lg:mt-44">
            ...
            <div class="pl-20 pr-20 flex flex-col mb-6">
              ...
              <p class="text-grey-darker text-2xl leading-tight">{text3}</p>
              <a
                class="text-xl bg-roxo py-3 rounded-lg text-white w-1/4 text-center text-bold block mt-6"
                onClick={handleClick}
              >
        ...
        <SwiperSlide>
          <div class="flex flex-col lg:flex-row overflow-hidden pl-20 pr-20 mt-14 lg:mt-44">
            <img
              class="block w-full lg:w-1/3 flex-none bg-cover lg:h-full rounded-xl"
              src="../images/manufatura.png"
            />
            <div class="pl-20 pr-20 flex flex-col mb-6">
              <div class="text-roxo font-bold text-center text-4xl mb-6 leading-tight">
                Manufatura Digital
              </div>
              <p class="text-grey-darker text-2xl leading-tight">{text4}</p>
              <a
                class="text-xl bg-roxo py-3 rounded-lg text-white w-1/4 text-center text-bold block mt-6"
                onClick={handleClick}
              >
