  ...
  return (
    <>
      <button
        ...
        className='h-14 z-50 duration-500 text-[13px] border border-gray-400 border-l-4 rounded-xl w-[95%] shadow hover:shadow-none hover:rounded-none absolute left-[3px]'
      >
      </button>
